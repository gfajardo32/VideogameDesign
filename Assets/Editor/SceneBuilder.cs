...
public static class SceneBuilder
{
    ...
    public static void BuildItems()
    {
        ...
        {
            ("Milk",   -8f,  4f,  new Color(0.95f, 0.95f, 1.00f)),
            ("Bread",   8f,  4f,  new Color(0.85f, 0.65f, 0.30f)),
            ("Eggs",    0f,  1f,  new Color(1.00f, 0.95f, 0.75f)),
            ("Cheese", -8f, -2f,  new Color(1.00f, 0.85f, 0.10f)),
            ("Apples",  8f, -2f,  new Color(0.85f, 0.15f, 0.15f)),
        };
    ...
    public static void BuildNPCsAndHazards()
    {
        ...
        // Shoppers — now use random wander patrol, no waypoints needed
        Color shopperCol = new Color(0.6f, 0.6f, 0.65f);
        var shopperPositions = new Vector2[]
        {
            new Vector2(-8f,  4f),
            new Vector2( 8f,  1f),
            new Vector2( 0f,  3f),
